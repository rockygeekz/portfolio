...
const SEO = {
  title: "Rakesh S | Projects Portfolio",
  description:
    "Explore my portfolio of full-stack development and DevOps projects. Featuring Spring Boot, React, AWS, Docker, Kubernetes, and AI-powered applications.",
  keywords:
    "portfolio, full stack developer, Spring Boot projects, React applications, AWS cloud, Docker containers, Kubernetes, DevOps, CI/CD pipelines, AI applications, software engineer, backend developer, microservices",
};
...
const projects: Project[] = [
  {
    ...
    title: "DoxelAI",
    description:
      "Secure Document Analysis Vault with multi-format uploads (PDF, DOCX, XLSX, TXT up to 50 MB) featuring role-based access control and AES-256 encryption. Integrated Hugging Face NLP with regex fallback to auto-summarize documents and detect security threats, cutting manual review effort by 80%. Deployed using Docker and CI/CD pipelines on AWS (EC2, S3, RDS) achieving 99.9% uptime.",
    media: {
      type: "image",
      src: "/projects/doxelai.webp",
    },
    tags: ["Spring Boot", "PostgreSQL", "Supabase", "Hugging Face", "Docker", "AWS"],
    link: "https://doxelai.vercel.app",
    github: "https://github.com/rockygeekz/doxelai",
  },
  {
    id: 2,
    title: "FlowMate",
    description:
      "AI-Powered Workflow Automation SaaS platform to create, schedule, and run web scraping pipelines, handling 100+ concurrent tasks. Implemented Stripe-based subscription billing, managing 50+ recurring payments efficiently. Containerized and deployed services on AWS with Docker and Kubernetes, achieving 99.9% uptime.",
    media: {
      type: "image",
      src: "/projects/flowmate.webp",
    },
    tags: ["Next.js", "Node.js", "MongoDB", "Prisma", "Stripe", "Docker", "Kubernetes", "AWS"],
    link: "https://flowmate.vercel.app",
    github: "https://github.com/rockygeekz/flowmate",
  },
  {
    id: 3,
    title: "End-to-End DevOps Pipeline",
    description:
      "Production-grade DevOps pipeline for cloud-based microservices. Provisioned AWS infrastructure using Terraform and deployed microservices on EKS with Kubernetes for scalability. Automated CI/CD with GitHub Actions & ArgoCD, achieving zero-downtime deployments and accelerating release cycles.",
    media: {
      type: "image",
      src: "/projects/devops-pipeline.webp",
    },
    tags: ["AWS", "Docker", "Kubernetes", "Terraform", "GitHub Actions", "ArgoCD", "EKS"],
    link: "",
    github: "https://github.com/rockygeekz/devops-pipeline",
  },
];
  ...
  useEffect(() => {
    const structuredData = {
      ...
      mainEntity: {
        ...
        sameAs: ["https://github.com/rockygeekz"],
      },
    };
      ...
      >
        <div id="projects-container" className="max-w-7xl mx-auto px-4 py-8">
          ...
          <footer className="mt-20 text-center text-sm text-neutral-600 hidden">
            <p>
              Portfolio showcasing full-stack development and DevOps projects. 
              Built with Spring Boot, React, AWS, Docker, and Kubernetes.
            </p>
          </footer>
        </div>
      </div>
