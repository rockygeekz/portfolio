        ...
        >
          <div id="about-container" className="max-w-4xl">
            ...
            >
              ...
              >
                I&apos;m always looking for new challenges and technologies to
                explore. I enjoy working with driven people who share the same
                curiosity. I build full-stack applications using Spring Boot,
                React, Node.js, and integrate AI capabilities to create smarter solutions.
              </p>
              ...
              <p
                ...
                className="text-lg md:text-xl text-neutral-300 leading-relaxed"
              >
                Currently I&apos;m exploring AI engineering after discovering the possibilities with LLMs and agentic systems, and I&apos;m ready to build smarter applications with these tools.
              </p>
