...
const imageMetadata = {
  profile1: {
    url: "/smile.jpeg",
    alt: "Rakesh S - Full Stack Developer Primary Profile",
    width: 800,
    height: 800,
  },
  profile2: {
    url: "/smile.jpeg",
    alt: "Rakesh S - Full Stack Developer Alternate Profile",
    width: 800,
    height: 800,
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Final-year engineering student exploring full-stack development, DevOps practices, and AI-powered features.",
            }),
          }}
        />
      </Head>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              I turn complex ideas into clean, scalable systems that just work. From building APIs and automating deployments to crafting AI-driven tools, I love every part of the dev cycle. Whether it’s Dockerizing microservices or connecting LangChain agents to data — I’m usually busy teaching code how to think.
            </motion.p>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        "https://github.com/sponsors/rockygeekz",
                        "_blank"
                      )
                    }
                    className="relative z-10 w-full px-6 py-[6px] flex items-center justify-center gap-2 text-sm md:text-base"
              ...
              >
                ...
                <a
                  href="https://www.linkedin.com/in/rakeshs55/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-blue-500 transition-all duration-300 hover:scale-125 hover:-rotate-12"
                >
