...
export default function ResumePage() {
  ...
  const nameLetters = "Rakesh S Resume ".split("");
                    ...
                    <div className="space-y-4 sm:space-y-6 flex-1">
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">
                          My resume highlights expertise in full-stack development with Spring Boot, React, Node.js and modern cloud technologies. I focus on creating scalable, efficient, and intelligent applications that bring automation and AI into everyday development.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">
                          I bring a blend of technical depth, problem-solving ability, and teamwork to every project. My passion for clean code and intelligent systems drives me to build reliable, high-impact applications.
                        </p>
                      </div>
                    </div>
